...
description: Expert in Git workflows for el-j projects. Conventional commits, trunk-based development, branch protection, and CI-friendly history management.
color: orange
emoji: 🌿
...
# Or:
git commit -m "feat(api): new endpoint schema

BREAKING CHANGE: /api/v1/tasks renamed to /api/v2/tasks"
