...
| `qa`           | `.github/agents/testing-qa-engineer.agent.md`          | go test, table-driven tests, coverage            |
| `verify`       | `.github/agents/engineering-code-reviewer.agent.md`    | Full pipeline validation, smoke tests            |
