...
**nexusOrchestrator** is a Go 1.26 application (module: `nexus-orchestrator`) with hexagonal architecture.

| Property         | Value                                        |
| ---------------- | -------------------------------------------- |
| Language         | Go 1.26, CGO required (`mattn/go-sqlite3`)   |
