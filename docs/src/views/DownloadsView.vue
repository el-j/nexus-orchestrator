...
const desktopCards = [
  { icon: '🍎', platform: 'macOS', arch: 'Apple Silicon (M1/M2/M3/M4)', ext: '.zip', osKey: 'mac-arm', url: `${baseURL}/nexus-orchestrator-desktop-darwin-arm64.zip` },
  { icon: '🍎', platform: 'macOS', arch: 'Intel (x86_64)', ext: '.zip', osKey: 'mac-intel', url: `${baseURL}/nexus-orchestrator-desktop-darwin-amd64.zip` },
