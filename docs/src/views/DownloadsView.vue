  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <section class="mb-16">
      <div class="flex items-center gap-3 mb-6 reveal">
        ...
        <span
          class="px-2 py-0.5 text-xs rounded-full bg-violet-600/20 border border-violet-500/30 text-violet-300"
          >Recommended</span
        >
      </div>
      <p class="text-slate-500 mb-8 reveal">
        Full GUI with built-in HTTP API and MCP server. Best for most users.
      </p>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div v-if="isRecommended(card.osKey)" class="mb-2">
            <span class="px-2 py-0.5 text-xs rounded-full bg-violet-600 text-white font-bold"
              >Recommended</span
            >
          </div>
    ...
    <section class="mb-16">
      <div class="flex items-center gap-3 mb-6 reveal">
        ...
        <span
          class="px-2 py-0.5 text-xs rounded-full bg-cyan-600/20 border border-cyan-500/30 text-cyan-300"
          >New</span
        >
      </div>
      <p class="text-slate-500 mb-8 reveal">
        Submit tasks, monitor the queue, and switch providers without leaving your editor. Requires
        VS Code 1.85+ and a running nexus daemon.
      </p>
      <div class="max-w-xs reveal">
        <div
          class="rounded-xl border border-white/8 bg-[#0d0d14] hover:border-cyan-500/30 p-6 text-center transition-all"
        >
      ...
      <p class="text-xs text-slate-600 mt-4 reveal">
        ...
        <code class="text-slate-400">code --install-extension nexus-orchestrator-vscode.vsix</code>
      </p>
    </section>
    ...
    <section class="mb-16 reveal">
      ...
      <div class="rounded-xl border border-white/8 bg-[#0d0d14] p-8 text-center">
        ...
        <p class="text-xs text-slate-600 mt-4">
          Detects your OS and architecture automatically. Installs to
          <code class="text-slate-400">~/.local/bin</code>.
        </p>
      </div>
    </section>
    ...
    <section class="mb-16 reveal">
      ...
      <p class="text-slate-500 mb-6">
        Each release includes <code class="text-slate-300">SHA256SUMS.txt</code> with SHA-256 hashes
        for every archive.
      </p>
...
const requirements = [
  ...
  },
  {
    ...
    items: [
      ...
      'GTK 3 and WebKit2GTK (Desktop app)',
    ],
  },
  {
    icon: '🔧',
    ...
    items: [
      'Go 1.26+ with <code class="text-slate-300">CGO_ENABLED=1</code>',
      'C compiler (gcc / clang) for sqlite3',
      '<a href="https://wails.io/" class="text-violet-400">Wails v2</a> for Desktop builds',
    ],
  },
];
